...
function removePvzPrefix(address) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (btnDeliveryCdekOk && deliveryCdekModalElement) {
        ...
        btnDeliveryCdekOk.addEventListener('click', function () {
            ...
            document.getElementById('input-delivery-address').value =  removePvzPrefix(selectedText);
...
document.getElementById('delivery-cdek-modal')?.addEventListener('show.bs.modal', function () {
    const cityCode = document.getElementById('input-delivery-address-city-code')?.value || '';
    const city = document.getElementById('input-delivery-address-city')?.value || '';
    const pvzCode = document.getElementById('input-delivery-point-code')?.value || '';
    const address = removePvzPrefix(document.getElementById('input-delivery-address')?.value || '');

    const citySearchInput = document.getElementById('input-delivery-cdek-city-search');
    const citySelect = document.getElementById('select-delivery-cdek-city');
    const pvzSelect = document.getElementById('select-delivery-cdek-pvz');
    const addressInput = document.getElementById('input-delivery-cdek-city-address');
    ...
    if (citySelect && cityCode) {
        citySelect.innerHTML = '';

        const option = document.createElement('option');
        option.value = cityCode;
        option.textContent = city || cityCode;
        option.dataset.city = city;

        citySelect.appendChild(option);
    }

    if (pvzSelect && pvzCode) {
        pvzSelect.innerHTML = '';

        const option = document.createElement('option');
        option.value = pvzCode;
        option.textContent = `[${pvzCode}] ${address}`;
